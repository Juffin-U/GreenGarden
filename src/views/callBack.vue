<template>
  ...
  <div class="mainCallBackCont">
    ...
    <div class="mapCont">
      <div class="map">
        <iframe
          src="https://yandex.ru/map-widget/v1/?um=constructor%3A96f9528ff6e2dde2f9f9570c1b81d71af7ab2207911b149282ec217d06c17d71&amp;source=constructor"
          width="100%"
          height="100%"
          frameborder="0"
        ></iframe>
    ...
    <div class="linkPanel">
      ...
      <div class="socialButton">
        <a href="https://ok.ru/group/59987890733310">
          <svg
            class="t-sociallinks__svg"
            version="1.1"
            id="Layer_1"
      ...
      <div class="socialButton">
        <a href="https://www.instagram.com/greensad22/"
          ><svg
            class="t-sociallinks__svg"
            version="1.1"
            id="Layer_1"
    ...
    <div class="contactCont">
      <div>Телефон: +7 (913) 210-19-19</div>
      <div>Почта: green_sad22@mail.ru</div>
    </div>
  </div>
</template>

<script>
import HatComponent from "@/components/Environment/HatCompomnent";
import { useMeta } from "vue-meta";
export default {
  name: "callBack",
  setup() {
    useMeta({ title: "Обратная связь" });
  },
